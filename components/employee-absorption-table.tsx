...
export function EmployeeAbsorptionTable() {
  ...
  const [regionalGrandTotal, setRegionalGrandTotal] = useState({
    projects: 0,
    labor: 0,
  });
  ...
  const [subsectorGrandTotal, setSubsectorGrandTotal] = useState({
    projects: 0,
    labor: 0,
  });
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-amber-200">
              <TableHead className="table-header-orange w-20">
                Peringkat
              </TableHead>
              <TableHead className="table-header-orange">
                Kabupaten/Kota
              </TableHead>
              <TableHead className="table-header-orange">
                Jumlah Proyek
              ...
              <>
                {regionalData.map((row) => (
                  <TableRow key={row.id} className="table-row-yellow">
                    ...
                    <TableCell className="font-medium text-green-600">
                      {row.labor_count.toLocaleString()}
                    </TableCell>
                    <TableCell className="text-center">
                      <Badge
                        variant="secondary"
                ...
                <TableRow className="border-t-2 border-gray-300 bg-gray-50 font-bold">
                  ...
                  <TableCell className="font-bold text-green-700">
                    {regionalGrandTotal.projects.toLocaleString()}
                  </TableCell>
                  <TableCell className="font-bold text-green-700">
                    {regionalGrandTotal.labor.toLocaleString()}
                  </TableCell>
                  <TableCell className="text-center">
                    <Badge
                      variant="default"
              ...
              <>
                ...
                <TableRow className="border-t-2 border-gray-300 bg-gray-50 font-bold">
                  ...
                  <TableCell className="font-bold text-purple-700">
                    {subsectorGrandTotal.projects.toLocaleString()}
                  </TableCell>
                  <TableCell className="font-bold text-purple-700">
                    {subsectorGrandTotal.labor.toLocaleString()}
                  </TableCell>
                  <TableCell className="text-center">
                    <Badge
                      variant="default"
  ...
  const getCurrentTotalPages = () => {
    switch (activeTab) {
      case "regional":
        return regionalTotalPages;
      case "subsector":
        return subsectorTotalPages;
      default:
        return 1;
    }
  };
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-100">
        <div>
          <h3 className="text-lg font-medium text-gray-900">
            Peringkat Berdasarkan Tenaga Kerja PMA/PMDN
          </h3>
      ...
      {getCurrentData().length > 0 && (
        <div className="flex items-center justify-between p-6 border-t border-gray-100">
          <p className="text-sm text-gray-500">
            ...
            {Math.min(getCurrentPage() * pageSize, getCurrentCount())} dari{" "}
