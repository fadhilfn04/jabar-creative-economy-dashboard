...
interface OptimizedDatabaseFiltersProps {
...
export function OptimizedDatabaseFilters({ onFiltersChange }: OptimizedDatabaseFiltersProps) {
  ...
  useEffect(() => {
    const fetchFilterOptions = async () => {
      try {
        setLoading(true)
        const options = await UnifiedDatabaseService.getFilterOptions()
    ...
    <div className="minimal-card p-6">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Cari Pelaku Ekonomi Kreatif, NIB, No Izin, atau KBLI..."
