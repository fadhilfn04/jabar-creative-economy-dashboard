  ...
  const insights = [
    {
      ...
      description: 'Pertumbuhan pelaku ekonomi kreatif menunjukkan tren positif dengan rata-rata 12.5% per tahun',
      confidence: 92
    },
    {
      type: 'warning',
      title: 'Ketimpangan Regional',
      description: 'Terdapat kesenjangan signifikan antara wilayah urban dan rural dalam penyerapan investasi',
      confidence: 78
    },
    {
      type: 'opportunity',
      title: 'Potensi Subsektor Digital',
      description: 'Subsektor aplikasi dan game developer menunjukkan potensi pertumbuhan tertinggi',
      confidence: 85
    }
  ]
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Analisis prediktif dan insights mendalam</p>
        </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-wrap gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Metrik Analisis</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700">Periode Forecast</label>
          ...
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <ScatterChart data={correlationData}>
                  ...
                  <Tooltip 
                    formatter={(value: number, name: string) => [
                      value.toLocaleString(), 
                      name === 'investment' ? 'Investasi (Juta Rp)' : 'Tenaga Kerja'
                    ]}
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-2">Analisis Korelasi</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-gray-600">Koefisien Korelasi: <span className="font-medium text-green-600">0.87</span></p>
                    <p className="text-gray-600">R-squared: <span className="font-medium">0.76</span></p>
                  </div>
                  <div>
                    <p className="text-gray-600">Interpretasi: <span className="font-medium text-blue-600">Korelasi Kuat Positif</span></p>
                    <p className="text-gray-600">Setiap Rp 1M investasi ≈ 0.6 tenaga kerja</p>
                  </div>
                </div>
              </div>
            </CardContent>
                ...
                {insights.map((insight, index) => (
                  <div key={index} className="p-4 rounded-lg border border-gray-200">
                    <div className="flex items-start gap-3">
                      ...
                      {insight.type === 'opportunity' && <TrendingUp className="w-5 h-5 text-blue-600 mt-0.5" />}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Efisiensi Investasi</span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Diversifikasi Subsektor</span>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Penyebaran Regional</span>
        ...
        <TabsContent value="scenarios" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-green-200 bg-green-50">
              <CardHeader>
                <CardTitle className="text-green-800">Skenario Optimis</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="text-center">
                    <p className="text-3xl font-bold text-green-900">+25%</p>
                    <p className="text-sm text-green-700">Pertumbuhan proyeksi</p>
                  </div>
                  <div className="space-y-2 text-sm">
                    <p className="text-green-800">• Investasi naik 30%</p>
                    <p className="text-green-800">• Tenaga kerja naik 20%</p>
                    <p className="text-green-800">• 5 subsektor baru berkembang</p>
                  </div>
            ...
            <Card className="border-blue-200 bg-blue-50">
              <CardHeader>
                <CardTitle className="text-blue-800">Skenario Realistis</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="text-center">
                    <p className="text-3xl font-bold text-blue-900">+15%</p>
                    <p className="text-sm text-blue-700">Pertumbuhan proyeksi</p>
                  </div>
                  <div className="space-y-2 text-sm">
            ...
            <Card className="border-orange-200 bg-orange-50">
              <CardHeader>
                <CardTitle className="text-orange-800">Skenario Konservatif</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="text-center">
                    <p className="text-3xl font-bold text-orange-900">+8%</p>
                    <p className="text-sm text-orange-700">Pertumbuhan proyeksi</p>
                  </div>
                  <div className="space-y-2 text-sm">
